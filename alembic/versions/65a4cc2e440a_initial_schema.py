...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_current_observation_recorded_at"),
        "current_observation",
        ["recorded_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_wind_observation_recorded_at"),
        "wind_observation",
        ["recorded_at"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_wind_observation_recorded_at"), table_name="wind_observation"
    )
    ...
    op.drop_table("job")
    op.drop_index(
        op.f("ix_current_observation_recorded_at"), table_name="current_observation"
    )
